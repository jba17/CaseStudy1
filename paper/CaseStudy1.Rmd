...
```{r echo=FALSE}
read_chunk('../source/Setup.R')
read_chunk('../source/DownloadData.R')
read_chunk('../source/CleanData.R')
read_chunk('../source/Question1.R')
read_chunk('../source/Question2.R')
read_chunk('../source/Question3.R')
read_chunk('../source/Question4.R')
read_chunk('../source/Question5.R')
```
...
```{r code=readLines("../source/DownloadData.R") ,echo=TRUE}
```
```{r download}
<<Download>>
```
